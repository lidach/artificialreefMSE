...
#' AR_ref_2 - place artificial reefs near historical ones (goes by TAC)
...
run_future_OM <-
  function(seed,
    ...
    with(OM_list, {
      ...
      Fnew <- TAC/VBtemp[nyears_future-nyear_forward]
      ...
      for (y in nyears_beg:nyears_end) {
        ...
        if (TAC_flag) FM[y, , ] <- Fnew2[y, ] * lh_list$S_fa
